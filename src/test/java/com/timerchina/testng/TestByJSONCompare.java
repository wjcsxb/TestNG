...
public class TestByJSONCompare extends BaseTest{
    ...
    @Test(dataProvider = "WorkBookData", description = "ReqGenTest", enabled = true,invocationCount=500,threadPoolSize=100)
    public void apiRunTest(String ID, String testCase) {
        ...
        try {
            ...
            myReqGen.setCookieList("Authorization","u_12_248768e4333a65ed01975ce15fddb86e");
